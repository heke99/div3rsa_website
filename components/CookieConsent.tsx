...
export function CookieConsent() {
  ...
  return (
    <>
      {open ? (
        <div className="cookie-consent" role="dialog" aria-label="Cookieinställningar" aria-live="polite">
          <div className="cookie-consent-copy">
            <strong>Cookies och integritet</strong>
            <p>
              Vi använder nödvändig teknisk lagring för webbplatsens funktion och säkerhet. Valfria cookies eller liknande lagring för exempelvis statistik får bara användas efter ditt val.
            </p>
            <Link href="/cookiepolicy">Läs vår cookiepolicy</Link>
          </div>
