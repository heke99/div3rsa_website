...
export const metadata = pageMetadata({ title: "Websites", description: "Thoughtful company and product websites. Clear content, distinctive design and a connected enquiry journey.", path: "/websites" });
