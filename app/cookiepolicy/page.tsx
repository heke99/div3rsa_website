...
export const metadata:Metadata={title:"Cookie policy",description:"What this website stores in your browser and how you control it.",alternates:{canonical:"/cookies"}};
