...
export const metadata = pageMetadata({ title: "Business payments & Bankgiro", description: "Discuss invoicing, customer payments and Bankgiro workflow requirements.", path: "/business-payments" });
