...
export const metadata: Metadata = { title: "Business payment application", description: "Tell us about your company and payment requirements.", alternates: { canonical: "/business-payments/apply" } };
